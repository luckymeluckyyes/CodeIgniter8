...
<script type="text/javascript">
  $(function(){
    $('#update').on('click', function(){
      ...
      $.ajax({
        url: "<?php echo site_url('user/edit_process'); ?>",
        type: "post",
        data: {
          user_id:uid,
          name:n,
...
<body>
  <div class="container">
    ...
    <?php 
      ...
      $pass_attr = array('name' => 'password', 'class' => 'form-control', 'placeholder' => 'Password', 'id' => 'inputPassword', 'type' => 'text', 'value' => $users[0]['password']);
      echo form_password($pass_attr);

       echo form_label('Phone', 'inputPhone', array('class' => "sr-only"));
      $phone_attr = array('name' => 'phone', 'class' => 'form-control', 'placeholder' => 'Phone', 'id' => 'inputPhone', 'type' => 'text', 'value' => $users[0]['phone']);
      echo form_input($phone_attr);

      echo '<br>';

      $btn_attr = array('name' => 'submit', 'id' => 'update', 'content' => 'Update', 'class' => 'btn btn-lg btn-primary btn-block', 'type' => 'button');
