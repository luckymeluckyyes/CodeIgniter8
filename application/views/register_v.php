...
<script type="text/javascript">
  $(function(){
    $('#submit').click(function(){
      ...
      var cpass = $('#inputConPassword').val();
      var p = $('#inputPhone').val();

      console.log("Starting ajax");
      $.ajax({
        url: "<?php echo site_url('register/register_process'); ?>",
        type: "post",
        data: {
          submit:s,
          name:n,
        ...
        //u can use this instead above and can serialize the form
...
<body>
  <div class="container">
    ...
    <?php 
      ...
      echo form_open('register/register_process', $form_attr);
    ?>
      ...
      <?php 
        ...
        $con_pass_attr = array('name' => 'con_password', 'class' => 'form-control', 'placeholder' => 'Confirm Password', 'id' => 'inputConPassword', 'type' => 'password');
        echo form_password($con_pass_attr);

        echo form_label('Phone', 'inputPhone', array('class'=>"sr-only"));
        $phone_attr = array('name' => 'phone', 'class' => 'form-control', 'placeholder' => 'Phone', 'id' => 'inputPhone', 'type' => 'tel');
        echo form_input($phone_attr);

        echo '<br>';

        $btn_attr = array('name' => 'submit', 'id' => 'submit', 'content' => 'Register', 'class' => 'btn btn-lg btn-primary btn-block', 'type' => 'button');
