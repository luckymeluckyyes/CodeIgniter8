...
<body>
  <div class="container">
    ...
    <?php 
      ...
      echo form_open('register/login_process', $form_attr);
    ?>
      <h2 class="form-signin-heading">Please Sign in</h2>
      <?php 

        echo form_label('Email Address', 'inputEmail', array('class'=>"sr-only"));
        $email_attr = array('name' => 'email', 'value' => set_value('email', ''), 'class' => 'form-control', 'placeholder' => 'Email Address', 'id' => 'inputEmail', 'type' => 'text');
        ...
        $btn_attr = array('name' => 'submit', 'content' => 'Login', 'class' => 'btn btn-lg btn-primary btn-block', 'type' => 'submit');
